...
#Global cbrgen file for DSR protocol
set val(cp) "./indep-utils/cmu-scen-gen/cbrgen-network-load-20"
set val(sc) "./indep-utils/cmu-scen-gen/setdest/setdest-network-load-20"
# Create simulator
set ns_ [new Simulator]
# Set up trace file
set tracefd [open DSR-netload-20-out.tr w] ;# for wireless traces
$ns_ trace-all $tracefd
set namtrace [open DSR-netload-20-out.nam w]
