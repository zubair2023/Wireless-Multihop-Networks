...
set val(seed) 1.0
#Global cbrgen file for AODV protocol
set val(cp) "./indep-utils/cmu-scen-gen/cbrgen-mobility-test"
#Global setdest file , pause time 60 seconds
set val(sc) "./indep-utils/cmu-scen-gen/setdest/setdest-mobility-60"
set val(stop) 240 ;# simulation time
# Create simulator
set ns_ [new Simulator]
# Set up trace file
set tracefd [open AODV-mobility-60-out.tr w] ;# for wireless traces
$ns_ trace-all $tracefd
set namtrace [open AODV-moblity-60-out.nam w]
